            ...
            <div className="flex w-full flex-row items-center justify-center">
                <div className="flex space-x-4">
                    ...
                    {isPlaying ? (<button
                        ...
                        aria-label="Pause"
                        className="lg:h-20 lg:w-20 md:h-20 md:w-20 -mt-2 h-14 w-14 glass2 btn rounded-full flex items-center justify-center">
                        <Pause />
                    </button>
                    ) : (
                        <button
                            ...
                            aria-label="Play"
                            className="lg:h-20 lg:w-20 md:h-20 -mt-2 md:w-20 h-14 w-14 glass2 btn rounded-full flex items-center justify-center">
                            <Play />
                        </button>
                    )}
